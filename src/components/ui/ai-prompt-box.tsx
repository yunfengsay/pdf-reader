...
import { ArrowUp, Paperclip, Square, X, StopCircle, Mic, Globe, Brain, Code2 } from "lucide-react";
      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl border border-gray-200 bg-white p-2 shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-300",
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const { onSend = () => {}, isLoading = false, placeholder = "Type your message here...", className, initialValue = "", onInputChange } = props;
  ...
  return (
    <>
      <PromptInput
        ...
        className={cn(
          "w-full bg-white border-gray-200 shadow-md transition-all duration-300 ease-in-out",
